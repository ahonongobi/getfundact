        ...
        <footer class="footer-area pt-100">
            <div class="container">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-item">
                            <div class="footer-links">
                                <h3>Quick links</h3>
                                <ul>
                                    <li><a href="about.php"><i class="icofont-simple-right"></i>About</a></li>
                                    <li><a href="blog.php"><i class="icofont-simple-right"></i>Blog</a></li>
                                    <li><a href="events.php"><i class="icofont-simple-right"></i>Events</a></li>
                                    <li><a href="donation.php"><i class="icofont-simple-right"></i>Donation</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="copyright-area">
                    <p>Copyright ©2021 Findo. Designed By
                        <a href="https://intelligencia-tech.com/" target="_blank">intelligencia-tech</a>
                    </p>
                </div>
            </div>
        </footer>
