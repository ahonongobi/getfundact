...
<table id="example" class="display nowrap table-responsive" style="width:100%">
    ...
    <tbody>
        @foreach ($admin_all_campagne_actif as $item)
        <tr>
            <td>{{ $item->name }}</td>
                                ...
                                @foreach ($admin_all_campagne_actif as $item)
                                    <tr>
                                        ...
                                        <button>
                                            ...
                                            <button
                                                class="btn btn-warning rounded-0 text-white">${{ $item->montant_v }}</button>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('see-more-campagne/' . $item->id) }}"
                                                class="btn btn-warning rounded-0 text-white"><i
                                                    class="ti-eye menu-icon"></i></a>
