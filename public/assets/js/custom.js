...
//here i made a dark and light theme but not finished yet so i will add it later
...
$('.newsletter-form').ajaxChimp({url:'https://hibootstrap.us20.list-manage.com/subscribe/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9',callback:callbackFunction});$('body').append("<a href='https://themeforest.net/checkout/from_item/29834649?license=regular&support=bundle_6month&_ga=2.45219939.634514020.1646539215-1425290503.1590986634' target='_blank' class='buy-now-btn'></a>");$('body').append("<div class='switch-box'><label id='switch' class='switch'><input type='checkbox' onchange='toggleTheme()' id='slider'><span class='slider round'></span></label></div>");}(jQuery));function setTheme(themeName){localStorage.setItem('findo_theme',themeName);document.documentElement.className=themeName;}
