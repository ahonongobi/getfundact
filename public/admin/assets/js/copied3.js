...
var copyToClipboard = (function () { 
    var copyIcon =  document.querySelector(".copy-to-clipboard3");
    var toastBox =  document.querySelector(".toastbox");
    //get input copyIban value
    var pageUrl=  document.getElementById("copyBanque").value;
        ...
        var textarea, result;
          ...
          return true;
            ...
            copyIcon.addEventListener("click", function(){
              showToastBox(isCopying(pageUrl) ? "Le nom copier avec succès" : "Impossible de copier le nom de la banque");
          })
          }
