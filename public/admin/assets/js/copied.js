...
var copyToClipboard = (function () { 
  var copyIcon = document.querySelector(".copy-to-clipboard") || document.querySelector(".copy-to-clipboard2") || document.querySelector(".copy-to-clipboard3");
  var toastBox =  document.querySelector(".toastbox");
  //get input copyIban value
  var pageUrl= document.getElementById("copyIban").value || document.getElementById("copyBic").value || document.getElementById("copyBanque").value;
      ...
      var textarea, result;
        ...
        return true;
          ...
          copyIcon.addEventListener("click", function(){
            showToastBox(isCopying(pageUrl) ? "Iban copier avec succès" : "Impossible de copier l'iban");
        })
        }
